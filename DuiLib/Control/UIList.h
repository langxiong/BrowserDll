...
typedef int (__cdecl  *PULVCompareFunc)(UINT_PTR, UINT_PTR, UINT_PTR);
...
public:
    ...
    void SetSepItemImage(LPCTSTR pStrSepItemImage);
    void SetSepItemWidth(int nSepItemWidth);
...
class UILIB_API CListHeaderItemUI : public CVerticalLayoutUI
{
public:
    CListHeaderItemUI();
...
public:
    ...
    void SetItemText(LPCTSTR pstrText);
    int GetItemTextCount() const;
    ...
    RECT GetItemThumbRect(const RECT& rc, int nSepItemWidth) const;
