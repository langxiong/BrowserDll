...
public:
    ...
    unsigned int GetDarkness() const;

    bool SetPosition(int NewXOffset = 5, int NewYOffset = 5);
    POINT GetPoisition() const;
...
protected:
    ...
    static void OnFinalMessage(HWND hWnd);

    static CShadowUI* GetShadowUI(HWND hWnd);
