...
public:
    enum
    {
        WM_USER_DUILIB_ASYNC_NOTIFY = WM_USER + 30,
        WM_USER_DUILIB_DELAY_CLEAN_UP,
        WM_USER_DUILIB_DELAY_DESTROY_WNDS,
        WM_USER_DUILIB_DELAY_DESTROY_THREADS,
        WM_USER_UPDATE_UI_TEXT_ASYNC,
        WM_USER_UPDATE_UI_PROGRESS_VAL_ASYNC,
        WM_USER_UPDATE_UI_OPTION_STATUS_ASYNC,
    };
...
public:
    void Init(HWND hWnd, bool isFilterMsg = true);
    void NeedUpdate();
    ...
    bool UpdateUITextAsync(const CDuiString& strText, CControlUI* pCtrl);
    bool UpdateProgressValueAsync(int nValue, CControlUI* pCtrl);
    bool UpdateOptionStatusAsync(bool isSelected, CControlUI* pCtrl);
    ...
    void AddDelayedDestroyedWnd(CWindowWnd* pWnd);
    void AddDelayedDestroyedThread(std::thread* pThread);
...
private:
    ...
    CStdPtrArray m_aDelayedDestroyedWnds;
    CStdPtrArray m_aDelayedDestroyedThreads;
