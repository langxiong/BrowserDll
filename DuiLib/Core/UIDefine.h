...
#define DUI_MSGTYPE_MENUITEMECLICK         (_T("menuitemeclick"))
// 该消息用于部分扩展控件独立发送
#define DUI_MSGTYPE_ITEMKEYDOWN                (_T("itemkeydown"))

#define DUI_MSGTYPE_SELECTCHANGED            (_T("selectchanged"))
#define DUI_MSGTYPE_SELECTCHANGED 		   (_T("selectchanged"))
#define DUI_MSGTYPE_INPUT_HOTKEY			(_T("inputhotkey"))
#define	DUI_MSGTYPE_DBLCLICK				(_T("msg.dblclick"))
#define DUI_MSGTYPE_ZOOMSTATUSCHANGED		(_T("zoomstatuschanged"))
...
#define  DUI_CTR_VOLUME                          (_T("Volume"))
...
#define  DUI_CTR_CAMERALAYOUT                    (_T("CameraLayout"))
#define  DUI_CTR_WEBBROWSER                      (_T("WebBrowser"))
#define  DUI_CTR_NEWWEBBROWSER                   (_T("NewWebBrowser"))
...
#define  DUI_CTR_CANDLESTICKCHART                (_T("CandlestickChart"))
