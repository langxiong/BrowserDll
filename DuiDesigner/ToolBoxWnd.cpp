...
void CToolBoxWnd::InitToolList()
{
    ...
    pControlTab->AddSubTool(new CToolElement(_T("RichEdit"),classRichEdit,IDI_TOOLBOX_RICHEDIT));
    ...
    pControlTab->AddSubTool(new CToolElement(_T("WebBrowser"), classWebBrowser, IDI_TOOLBOX_WEBBROWSER));
    ...
    pLayoutTab->AddSubTool(new CToolElement(_T("CameraLayout"), classCameraLayout, IDI_TOOLBOX_TILE_LAYOUT));
