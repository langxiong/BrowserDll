...
protected:
    ...
    static void SaveListTextItemProperty(CControlUI* pControl, TiXmlElement* pNode);
...
//////////////////////////////////////////////////////////////////////////
//CNewFormTestWnd
class CNewFormTestWnd : public DuiLib::WindowImplBase
{
public:
    CNewFormTestWnd(DuiLib::CPaintManagerUI& paintManager, const DuiLib::CDuiString& strSkinFile);
    virtual ~CNewFormTestWnd();
...
private:
    DuiLib::CDuiString m_strSkinFile;
};
