...
#pragma region Control
    ...
    //shortcut
    pProp=new CMFCPropertyGridProperty(_T("Shortcut"),(_variant_t)_T(""),_T("指定该控件Systemchar"),tagShortcut);
    pPropUI->AddSubItem(pProp);
...
#pragma region Button
    ...
    pPropColor=new CMFCPropertyGridColorProperty(_T("HotTextColor"),(LONG)RGB(0,0,0),NULL,_T("指定按钮获得热点时文本的颜色"),tagHotTextColor);
    pPropColor->EnableOtherButton(_T("其他..."));
    pPropColor->EnableAutomaticButton(_T("默认"),::GetSysColor(COLOR_3DFACE));
    pPropUI->AddSubItem(pPropColor);

    pPropColor=new CMFCPropertyGridColorProperty(_T("PushedTextColor"),(LONG)RGB(0,0,0),NULL,_T("指定按钮被按压下时文本的颜色"), tagPushedTextColor);
    pPropColor->EnableOtherButton(_T("其他..."));
    pPropColor->EnableAutomaticButton(_T("默认"),::GetSysColor(COLOR_3DFACE));
    pPropUI->AddSubItem(pPropColor);

    pPropColor=new CMFCPropertyGridColorProperty(_T("FocusTextColor"),(LONG)RGB(0,0,0),NULL,_T("指定按钮获得焦点时文本的颜色"), tagFocusTextColor);
    pPropColor->EnableOtherButton(_T("其他..."));
    pPropColor->EnableAutomaticButton(_T("默认"),::GetSysColor(COLOR_3DFACE));
    pPropUI->AddSubItem(pPropColor);
...
#pragma region Edit
    ...
    //tagNumberOnly
    pProp=new CMFCPropertyGridProperty(_T("NumberOnly"),(_variant_t)false,_T("指示是否限定为数字"),tagNumberOnly);
    pPropUI->AddSubItem(pProp);
...
#pragma endregion RichEdit
    ...
    //align
    pProp=new CMFCPropertyGridProperty(_T("Align"),_T("Center"),_T("指示文本的对齐方式"),tagRichAlign);
    ...
    //textcolor
    pPropColor=new CMFCPropertyGridColorProperty(_T("TextColor"),(LONG)RGB(0,0,0),NULL,_T("指定文本的颜色"),tagRichTextColor);
    pPropColor->EnableOtherButton(_T("其他..."));
    pPropColor->EnableAutomaticButton(_T("默认"),::GetSysColor(COLOR_3DFACE));
    pPropUI->AddSubItem(pPropColor);

    //readonly
    pProp=new CMFCPropertyGridProperty(_T("ReadOnly"),(_variant_t)false,_T("指示是否只读"),tagRichReadOnly);
    pPropUI->AddSubItem(pProp);

    //password
    pProp=new CMFCPropertyGridProperty(_T("Password"),(_variant_t)false,_T("指示是否使用密码框"),tagRichPassword);
    pPropUI->AddSubItem(pProp);

    //font
    pProp=new CMFCPropertyGridProperty(_T("Font"),(_variant_t)(LONG)-1,_T("指定文本的字体"),tagRichFont);
    pPropUI->AddSubItem(pProp);
...
#pragma region Option
    ...
    pPropColor = new CMFCPropertyGridColorProperty(_T("selectedtextcolor"), (LONG)RGB(0, 0, 0), NULL, _T("指定复选框被选择后的文字颜色"), tagSelectedTextColor);
    pPropColor->EnableOtherButton(_T("其他..."));
    pPropColor->EnableAutomaticButton(_T("默认"), ::GetSysColor(COLOR_3DFACE));
    pPropUI->AddSubItem(pPropColor);
...
#pragma region Item
    ...
    //ItemShowHtml
    pProp=new CMFCPropertyGridProperty(_T("ItemShowHtml"),(_variant_t)false,_T("指示是否使用ItemShowHtml格式文本\nFalse"),tagItemShowHtml);
    pPropUI->AddSubItem(pProp);

    //ItemSepImage
    pPropImage=new CMFCPropertyGridImageProperty(_T("ItemSepImage"),_T(""),_T("指定Item项间的分割图片"),tagItemSepImage);
    pPropImage->AllowEdit(FALSE);
    pPropUI->AddSubItem(pPropImage);

    pProp=new CMFCPropertyGridProperty(_T("ItemSepWidth"),(_variant_t)(LONG)0,_T("指定Item项间的分隔符宽,正负表示分隔符在左边还是右边\n0"), tagItemSepWidth);
    pPropUI->AddSubItem(pProp);
...
#pragma region List
    ...
    //headerbkcolor
    pPropColor=new CMFCPropertyGridColor32Property(_T("headerbkcolor"),(LONG)ARGB(0,0,0,0),NULL,_T("指定表头背景色值"),tagListHeaderBkColor);
    pPropColor->EnableOtherButton(_T("其他..."));
    pPropColor->EnableAutomaticButton(_T("默认"),::GetSysColor(COLOR_3DFACE));
    pPropUI->AddSubItem(pPropColor);
...
void CUIProperties::ShowControlProperty(CControlUI* pControl)
{
    ...
    //shortcut
    {
        COleVariant var(CDuiString(pControl->GetShortcut()));
        pPropControl->GetSubItem(tagShortcut-tagControl)->SetValue(var);
        pPropControl->GetSubItem(tagShortcut-tagControl)->SetOriginalValue(var);
    }
    //keyboard
...
void CUIProperties::ShowLabelProperty(CControlUI* pControl)
{
    ...
    if ((uStyle & DT_WORDBREAK) == DT_WORDBREAK)
    {
        strStyle += _T("wrap");
    }
    ...
    bool bEndEllipsis=((dwStyle&DT_END_ELLIPSIS) == DT_END_ELLIPSIS) !=0 ;
...
void CUIProperties::ShowButtonProperty(CControlUI* pControl)
{
    ...
    //focustextcolor
    static_cast<CMFCPropertyGridColor32Property*>(pPropButton->GetSubItem(tagFocusTextColor-tagButton))->SetColor((_variant_t)(LONG)(pButton->GetFocusedTextColor()));
    static_cast<CMFCPropertyGridColor32Property*>(pPropButton->GetSubItem(tagFocusTextColor-tagButton))->SetOriginalValue((_variant_t)(LONG)(pButton->GetFocusedTextColor()));
...
void CUIProperties::ShowOptionProperty(CControlUI* pControl)
{
    ...
    static_cast<CMFCPropertyGridColor32Property*>(pPropOption->GetSubItem(tagSelectedTextColor - tagOption))->SetOriginalValue((_variant_t)(LONG)(pOption->GetSelectedTextColor()));
...
void CUIProperties::ShowRichEditProperty(CControlUI* pControl)
{
    ShowContainerProperty(pControl);
    ASSERT(pControl);
    CRichEditUI* pRichEdit=static_cast<CRichEditUI*>(pControl->GetInterface(DUI_CTR_RICHEDIT));
    ASSERT(pRichEdit);
    ...
    // Align
    //align
    LONG uStyle = pRichEdit->GetWinStyle();
    CString strStyle;
    if ((uStyle & DT_CENTER) == DT_CENTER)
    {
        strStyle = _T("center");
    ...
    pPropRichEdit->GetSubItem(tagRichAlign-tagRichEdit)->SetValue((_variant_t)strStyle);
    pPropRichEdit->GetSubItem(tagRichAlign-tagRichEdit)->SetOriginalValue((_variant_t)strStyle);
...
void CUIProperties::ShowListProperty( CControlUI* pControl )
{
    ...
    pPropList->GetSubItem(tagListHeaderBkColor-tagList)->SetValue((LONG)pList->GetHeader()->GetBkColor());
    pPropList->GetSubItem(tagListHeaderBkColor-tagList)->SetOriginalValue((LONG)pList->GetHeader()->GetBkColor());
...
void CUIProperties::ShowItemProperty( CControlUI* pControl )
{
    ...
    //itemShowHtml
    pPropItem->GetSubItem(tagItemShowHtml-tagItem)->SetValue((_variant_t)pListInfo->bShowHtml);
    pPropItem->GetSubItem(tagItemShowHtml-tagItem)->SetOriginalValue((_variant_t)pListInfo->bShowHtml);
    //itemsepimage
    pPropItem->GetSubItem(tagItemSepImage-tagItem)->SetValue((_variant_t)pListInfo->sSepItemImage);
    pPropItem->GetSubItem(tagItemSepImage-tagItem)->SetOriginalValue((_variant_t)pListInfo->sSepItemImage);
    //itemsepwidth
    pPropItem->GetSubItem(tagItemSepWidth-tagItem)->SetValue((_variant_t)(LONG)pListInfo->nSepItemWidth);
    pPropItem->GetSubItem(tagItemSepWidth-tagItem)->SetOriginalValue((_variant_t)(LONG)pListInfo->nSepItemWidth);
...
void CUIProperties::ShowWebBrowserPropery( CControlUI* pControl )
{
    ...
    ASSERT(pControl);
    CNewWebBrowserUI* pWebBrowser=static_cast<CNewWebBrowserUI*>(pControl->GetInterface(DUI_CTR_NEWWEBBROWSER));
    ASSERT(pWebBrowser);
